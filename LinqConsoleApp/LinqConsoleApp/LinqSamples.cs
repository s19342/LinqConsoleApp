...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        public void Task3()
        {
            var res = Emps.Max(emps => emps.Salary);
        ...
        public void Task4()
        {
            var res = Emps.Where(emps => emps.Salary == (Emps.Max(emps => emps.Salary)));
        }
        ...
        public void Task7()
        {
            var res = Emps.GroupBy(emps => emps.Job)
                            .Select(r => new
                            {
                                EmployeeJob = r.Key,
                                Count = r.Count()
        ...
        public void Task8()
        {
            var res = Emps.Any(emps => emps.Job == "Backend programmer");
        }
        ...
        public void Task9()
        {
            var res = Emps.Where(emps => emps.Job == "Frontend programmer")
                            .OrderByDescending(emps => emps.HireDate).FirstOrDefault();
        }
        ...
        public void Task11()
        {
            var res = Emps.Aggregate((previous, next) => next.Salary > previous.Salary ? next : previous);
        }
